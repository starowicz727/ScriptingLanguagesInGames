...
class ShowTournaments(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        tournaments = list(tournaments_data["Tournaments"].keys())
...
class ShowAllData(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        response = ""
        for tournament, data in tournaments_data["Tournaments"].items():
            response += f"Tournament: {tournament}\n"
            response += "Players:\n"
            for player_id, player_name in data["Players"].items():
                response += f"- {player_name}\n"
            response += f"Current state: {data['Current state']}\n\n"
